...
namespace cppkit::crypto
{
  ...
  inline std::vector<uint8_t> pkcs7Pad(const std::vector<uint8_t>& data)
  {
    ...
    const size_t pad = block - (data.size() % block);
  ...
  inline std::vector<uint8_t> AES_Encrypt_ECB(const std::vector<uint8_t>& plaintext, const uint8_t key[16])
  {
    uint8_t roundKey[176];
    KeyExpansion(key, roundKey);
    const std::vector<uint8_t> padded = pkcs7Pad(plaintext);
  ...
  inline std::vector<uint8_t> AES_Decrypt_ECB(const std::vector<uint8_t>& ciphertext, const uint8_t key[16])
  {
  ...
  inline std::vector<uint8_t> AES_Encrypt_CBC(
  ...
  inline std::vector<uint8_t> AES_Decrypt_CBC(
  ...
  inline std::vector<uint8_t> fromString(const std::string& s)
  {
